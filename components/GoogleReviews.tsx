          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 bg-white border border-slate-200 shadow-sm rounded-full px-6 py-3 mb-8 hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2">
              ...
              <span className="font-black text-slate-800 text-lg">
                {data ? data.rating.toString().replace('.', ',') : "4,9"}
              </span>
            ...
            <span className="font-semibold text-slate-600 text-sm">
              {data ? data.total : "24"} avaliações verificadas
            </span>
          </div>
              ...
              >
                ...
                <div className="flex items-center gap-4 mt-auto">
                  {review.profile_photo_url ? (
                    <img src={review.profile_photo_url} alt={review.author_name} className="w-10 h-10 rounded-full shadow-sm" />
                  ) : (
