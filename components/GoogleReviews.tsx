  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "A migração da nossa loja para a VTEX nos dava muito medo por causa da perda de tráfego. A EyAgencia fez um mapeamento de URLs perfeito. Não só mantivemos o tráfego, como aumentamos o ROAS em 45% nos primeiros 3 meses.",
    },
    {
    ...
    <section className="w-full bg-white py-24 px-6 lg:px-8 border-t border-slate-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 flex flex-col items-center">
          <div className="flex items-center gap-2 bg-white border border-slate-200 shadow-sm rounded-full px-4 py-2 mb-6 cursor-pointer hover:bg-slate-50 transition-colors">
