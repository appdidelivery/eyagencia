            ...
            <div className="rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-xl group">
              ...
              <div className="relative aspect-video bg-zinc-900/50 flex flex-col items-center justify-center p-6 text-center group-hover:bg-zinc-900 transition-colors">
                <div className="w-full h-full border-2 border-dashed border-zinc-800 rounded-lg flex flex-col items-center justify-center text-zinc-600 p-4">
                  ...
                  <p className="font-semibold text-sm">Posicionamento Orgânico (SERP)</p>
                  <p className="text-xs mt-1 text-zinc-500 max-w-[200px]">Substitua pelo print de uma ferramenta (Ahrefs/Semrush) mostrando a subida de palavras-chave.</p>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-xl group">
                ...
                <div className="relative aspect-video bg-zinc-900/50 flex flex-col items-center justify-center p-6 text-center group-hover:bg-zinc-900 transition-colors">
                  <div className="w-full h-full border-2 border-dashed border-zinc-800 rounded-lg flex flex-col items-center justify-center text-zinc-600 p-4">
                    ...
                    <p className="font-semibold text-sm">Otimização de ROAS B2B</p>
                    <p className="text-xs mt-1 text-zinc-500 max-w-[200px]">Substitua pelo print do painel do Google Ads mostrando CPA reduzido.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-xl group">
              ...
              <div className="relative aspect-video bg-zinc-900/50 flex flex-col items-center justify-center p-6 text-center group-hover:bg-zinc-900 transition-colors">
                <div className="w-full h-full border-2 border-dashed border-zinc-800 rounded-lg flex flex-col items-center justify-center text-zinc-600 p-4">
                  ...
                  <p className="font-semibold text-sm">Retenção de Clientes no GA4</p>
                  <p className="text-xs mt-1 text-zinc-500 max-w-[200px]">Substitua pelo print do relatório de Retenção ou LTV (Lifetime Value).</p>
                </div>
              </div>
            </div>
          </section>
